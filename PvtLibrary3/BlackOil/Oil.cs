...
namespace PvtLibrary3.BlackOil
{
    public class Oil
    {
        ...
        public static double ComputeRs(BlackOilCorr blackOilCorr, double P, double T, double Pb, double Api,
                            double GasGravity, double Psp1, double Tsp1, double Psep, double Tsep,
                            double condensateGravity, double RsTotal,
                            double Rs1, double Rs2, double Rs3, double Gg2,
                            double Gg3, double Tst, double ygAve, SeparatorStage separatorTrain,
                            double Cp1 = 1, double Cp2 = 0)
        {
            double Rs = RsTotal;
            if(blackOilCorr == BlackOilCorr.Glaso)
            {
                Rs = RsGlaso(P, T, Pb, Api, RsTotal, Tst, ygAve, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.Standing)
            {
                Rs = RsStanding(P, T, Pb, Api, RsTotal, Tst, ygAve, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.VazquezBeggs)
            {
                Rs = RsVazquezBeggs(P, T, Pb, Api, Psep, Tsep, RsTotal, ygAve, Tst, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.Lasater)
            {
                Rs = RsLasater(P, T, Pb, Api, RsTotal, Tst, Cp1, Cp2);
            }
            else if (blackOilCorr == BlackOilCorr.Petrosky)
            {
                Rs = RsPetroskyFarshad(P, T, Pb, Api, RsTotal, Tst, ygAve, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.AlMarhoun)
            {
                Rs = RsAlMarhoun(P, T, Pb, Api, RsTotal, Tst, ygAve, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.DeGhetto)
            {
                Rs = RsDeGhetto(P, T, Api, GasGravity, Psep, Tsep, Cp1, Cp2);
            }
            return Rs;
        }
        ...
        public static double RsAlMarhoun(double P, double T, double Pb, double Api,
                                         double RsTotal, double Tst, double ygAve, 
                                         double Cp1 = 1, double Cp2 = 0 )
        {
            double Rs;
            if (P < Pb)
            {
                Rs = AlMarhounSaturatedRs(P, T, Api, ygAve, Tst);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double AlMarhounSaturatedRs(double P, double T, double Api, double ygAve, double Tst)
        {
            if (P < Tst) { return 0.0; }
                                         ...
                                         double gasGrav, double Psep, double Tsep)
        {
            ...
            double ygcor = gasGrav * ygcorterm1;
        ...
        public static double RsGlaso(double P, double T, double Pb, double Api,
                                     double RsTotal, double Tst, double ygAve,
                                     double Cp1 = 1.0, double Cp2 = 0.0 )
        {
            ...
            if (P < Pb)
            {
                Rs = GlasoSaturatedRs(P, T, Api, RsTotal, Tst, ygAve);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double GlasoSaturatedRs(double P, double T, double Api, double RsTotal, 
                                                double Tst, double ygAve)
        {
            if (P < Tst) { return 0.0; }
                                    ...
                                    double Cp1 = 1.0, double Cp2 = 0.0)
        {
            ...
            if (P < Pb)
            {
                Rs = LasaterSaturatedRs(P, T, Api, Tst, ygAve);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double LasaterSaturatedRs(double P, double T, double Api, double Tst, double ygAve)
        {
            if (P < Tst) { return 0.0; }
            double yo = 141.5 / (131.5 + Api);
            double Mo;
                                            ...
                                            double Cp1 = 1.0, double Cp2 = 0.0)
        {
            ...
            if (P < Pb)
            {
                Rs = PetroskySaturatedRs(P, T, Api, Tst, ygAve);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double PetroskySaturatedRs(double P, double T, double Api, double Tst, double ygAve)
        {
            if (P < Tst) { return 0.0; }
                                        ...
                                        double Cp1 = 1.0, double Cp2 = 0.0)
        {
            ...
            if (P < Pb)
            {
                Rs = StandingSaturatedRs(P, T, Api, Tst, ygAve);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double StandingSaturatedRs(double P, double T, double Api, double Tst, double ygAve)
        {
            if (P < Tst) { return 0.0; }
        ...
        /// <returns>returns Rs in scf/stb</returns>
        public static double RsVazquezBeggs(double P, double T, double Pb, double Api, double RsTotal, 
                                            double Psep, double Tsep,  double Tst, double ygAve,
                                            double Cp1 = 1.0, double Cp2 = 0.0)
        {
            double Rs;
            if (P < Pb)
            {
                Rs = VazquezSaturatedRs(P, T, Api, Psep, Tsep, Tst, ygAve);
            }
            else
            {
                Rs = RsTotal;
        ...
        internal static double VazquezSaturatedRs(double P, double T, double Api, double Psep, 
                                                 double Tsep, double Tst, double ygAve)
        {
            if (P < Tst) { return 0.0; }
        ...
        {
            double co;
            double ygcor = GasGravity * (1.0 + 0.00005912 * Api * Tsep * Log10(Psep / 114.7));
            if (Api < 10)
            {
        ...
        internal static double StandingUndersaturatedCo(double P, double Pb, double Bo,
                                                    double Rs, double Api, double ygAve)
        {
            //double rhoPb = new OilDensity().Density(input, input.RsTotal, bo);
            double rhoPb = OilDensity(Api, Rs, Bo, ygAve);
            double pDiff = P - Pb;
        ...
        public static double ComputeBo(BlackOilCorr blackOilCorr, double P, double T, double Pb,
                            double Rs, double Api, double RsTotal, double GasGravity, 
                            double Psep, double Tsep, double ygAve, double Cp1 = 1.0, 
                            double Cp2 = 0.0, double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double Bo = 0;
            if(blackOilCorr == BlackOilCorr.Glaso)
            {
                Bo = BoGlaso(P, T, Pb, Rs, Api, RsTotal, GasGravity,
                            Psep, ygAve, Tsep, Cp1, Cp2, Cp3, Cp4);
            }
            else if(blackOilCorr == BlackOilCorr.Standing)
            {
                Bo = BoStanding(P, T, Pb, Rs, Api, RsTotal, GasGravity, Psep,
                                Tsep, ygAve, Cp1, Cp2, Cp3, Cp4);
            }
            else if (blackOilCorr == BlackOilCorr.VazquezBeggs)
            {
                Bo = BoVazquezBeggs(P, T, Pb, Rs, Api, RsTotal, GasGravity,
                                    Psep, Tsep, ygAve, Cp1, Cp2, Cp3, Cp4);
            }
            else if(blackOilCorr == BlackOilCorr.Lasater)
            {
                Bo = BoLasater(P, T, Pb, Rs, Api, RsTotal, GasGravity,
                               Psep, Tsep, ygAve, Cp1, Cp2, Cp3, Cp4);
            }
            else if(blackOilCorr == BlackOilCorr.Petrosky)
            {
                Bo = BoPetroskyFarshard(P, T, Pb, Rs, Api, RsTotal, ygAve, Cp1, Cp2, Cp3, Cp4);
            }
            else if(blackOilCorr == BlackOilCorr.AlMarhoun)
            {
                Bo = BoAlMarhoun(P, T, Pb, Rs, Api, RsTotal, GasGravity,  
                                Psep, Tsep, ygAve, Cp1, Cp2, Cp3, Cp4);
            }
            else if(blackOilCorr == BlackOilCorr.DeGhetto)
            {
                Bo = BoDeGhetto(P, T, Pb, Rs, Api, GasGravity, RsTotal, Psep, Tsep, Cp1, Cp2, Cp3, Cp4);
            }
            return Bo;
        }
        ...
        public static double BoAlMarhoun(double P, double T, double Pb, double Rs, double Api, 
                                    double RsTotal, double GasGravity,
                                    double Psep, double Tsep, double ygAve, double Cp1 = 1.0,
                                    double Cp2 = 0.0, double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = AlMarhounBoFunc(T, Rs, Api, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
        ...
        internal static double AlMarhounBoFunc(double T, double Rs, double Api, double ygAve)
        {
            double yo, f, Bo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static double BoGlaso(double P, double T, double Pb, double Rs, double Api, 
                                    double RsTotal, double GasGravity, double Psep, 
                                    double Tsep, double ygAve, double Cp1 = 1.0, 
                                    double Cp2 = 0.0, double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = GlasoBoFunc(Rs, T, Api, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
        ...
        internal static double GlasoBoFunc(double Rs, double T, double Api, double ygAve)
        {
            double yo, B, A, Bo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static double BoLasater(double P, double T, double Pb, double Rs, double Api,
                                    double RsTotal, double GasGravity, double Psep, double Tsep,
                                    double ygAve, double Cp1 = 1.0, double Cp2 = 0.0, 
                                    double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = LasaterBoFunc(Rs, T, Api, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
        ...
        internal static double LasaterBoFunc(double Rs, double T, double Api, double ygAve)
        {
            double yo, Bo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static double BoPetroskyFarshard(double P, double T, double Pb, double Rs, double Api,
                                    double RsTotal, double ygAve, double Cp1 = 1.0, double Cp2 = 0.0,
                                    double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = PetroskyBoFunc(Rs, T, Api, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
            ...
            {
                double coave = PetroskyUndersaturatedCo(P, T, Api, RsTotal, ygAve);
                bo *= (1 - coave * (P - Pb));
                return Cp3 * bo + Cp4;
            }
        }

        internal static double PetroskyBoFunc(double Rs, double T, double Api, double ygAve)
        {
            double yo, A, Bo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static double BoStanding(double P, double T, double Pb, double Rs, double Api,
                                    ...
                                    double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = StandingBoFunc(T, Rs, Api, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
        ...
        internal static double StandingBoFunc(double T, double Rs, double Api, double ygAve)
        {
            double yo, Bo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static double BoVazquezBeggs(double P, double T, double Pb, double Rs, double Api,
                                    ...
                                    double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double bo = VazquezBoFunc(T, Rs, Api, Psep, Tsep, ygAve);
            if (P <= Pb) 
            { 
                return Cp1 * bo + Cp2; 
            }
        ...
        internal static double VazquezBoFunc(double T, double Rs, double Api, double Psep, 
                                        double Tsep, double ygAve)
        {
            double Bo, y;
            y = ygAve * (1 + (0.00005912 * Api * Tsep * Log10(Psep / 114.7)));
        ...
        // Bubble point
        public static double ComputePb(BlackOilCorr blackOilCorr, double T, double Api, 
                        double RsTotal, double Psep, double Tsep, double R3, double ygAve,
                        double yCO2, double yH2S, double yN2, bool PbImpurityCorrection,
                        SeparatorStage separatorTrain, double Cp1 = 1.0, double Cp2 = 0.0)
        {
            double Pb = 0;
            if (blackOilCorr == BlackOilCorr.Glaso)
            {
                Pb = PbGlaso(T, Api, RsTotal, ygAve, yCO2, yH2S, yN2, 
                            PbImpurityCorrection, Cp1, Cp2);
            }
            else if (blackOilCorr == BlackOilCorr.Standing)
            {
                Pb = PbStanding(T, Api, RsTotal, ygAve, yN2, PbImpurityCorrection, Cp1, Cp2);
            }
            else if (blackOilCorr == BlackOilCorr.VazquezBeggs)
            {
                Pb = PbVazquezBeggs(T, Api, RsTotal, ygAve, yN2, PbImpurityCorrection, Cp1, Cp2);
            }
            else if (blackOilCorr == BlackOilCorr.Lasater)
            {
                Pb = PbLasater(T, Api, RsTotal, ygAve, yN2, PbImpurityCorrection, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.Petrosky)
            {
                Pb = PbPetroskyFarshard(T, Api, RsTotal, ygAve, yN2, PbImpurityCorrection, Cp1, Cp2);
            }
            else if(blackOilCorr == BlackOilCorr.AlMarhoun)
            {
                Pb = PbAlMarhoun(T, Api, RsTotal, ygAve, yN2, PbImpurityCorrection, Cp1, Cp2);
            }else if (blackOilCorr == BlackOilCorr.DeGhetto)
            {
                Pb = PbDeGhetto(T, Api, RsTotal, Psep, Tsep, R3, ygAve, yN2, 
        ...
        public static double PbAlMarhoun(double T, double Api, double RsTotal, double ygAve,
                                        double yN2, bool PbImpurityCorrection, 
                                        double Cp1 = 1.0, double Cp2 = 0.0)
        {
            double yo = 141.5 / (131.5 + Api);
        ...
        /// <param name="T">temperature in fahrenheit</param>
        /// <returns>returns bubble point pressure in psia</returns>
        public static double PbDeGhetto(double T, double Api, double RsTotal, double Psep, 
                                    double Tsep, double R3, double ygAve, double yN2, 
                                    ...
                                    double Cp1 = 1.0, double Cp2 = 0.0)
        {
            ...
            if (Api < 10)
            {
                pb = ExtraHeavyOilPb(T, Api, RsTotal, ygAve, R3, separatorTrain);
            }
            else if (Api < 22.3 && Api >= 10)
            {
                pb = HeavyOilPb(T, Api, Psep, Tsep, RsTotal, R3, ygAve, separatorTrain);
            }
            else if (Api >= 22.3 && Api < 31.1)
            {
                pb = MediumOilPb(T, Api, Psep, Tsep, RsTotal, R3, ygAve, separatorTrain);
            }
            else
            {
                pb = LightOilPb(T, Api, RsTotal, R3, ygAve, separatorTrain);
            }
        ...
        private static double ExtraHeavyOilPb(double T, double Api, double RsTotal, double R3, 
                                            double ygAve, SeparatorStage separatorTrain)
        {
            double Rs = RsTotal;
            ...
            double T1 = Pow((Rs / ygAve), (1 / 1.1128));
        ...
        //}
        #endregion
        private static double HeavyOilPb(double Temperature, double Api, double Psep, 
                                        double Tsep, double RsTotal, double R3, double ygAve,
                                        SeparatorStage separatorTrain)
        {
            ...
            double ygcor = ygAve * (1.0 + 0.00005912 * Api * Tsep * Log10(Psep / 114.7));
        ...
        private static double MediumOilPb(double T, double Api, double Psep, double Tsep, double RsTotal,
                                         double R3, double ygAve, SeparatorStage separatorTrain)
        {
            double Rs = RsTotal;
            if (separatorTrain == SeparatorStage.TwoStages)
            {
            ...
            double ygcor = ygAve * T1;
            double denom = 0.09902 * Pow(ygcor, 0.2181) * Pow(10, ((7.2153 * Api) / (T + 460)));
            double Pbm = Pow((Rs / denom), 0.9997);
            return Pbm;
        }

        private static double LightOilPb(double T, double Api, double RsTotal, double R3,
                                        double ygAve, SeparatorStage separatorTrain)
        {
            double Rs = RsTotal;
            if (separatorTrain == SeparatorStage.TwoStages)
        ...
        public static double PbGlaso(double T, double Api, double RsTotal, double ygAve, double yCO2,
                                    double yH2S, double yN2, bool PbImpurityCorrection, 
                                    double Cp1 = 1.0, double Cp2 = 0.0)
        {
        ...
        public static double PbLasater(double T, double Api, double RsTotal, double ygAve, double yN2,
                                    bool PbImpurityCorrection, double Cp1 = 1.0, double Cp2 = 0.0)
        {
        ...
        public static double PbPetroskyFarshard(double T, double Api, double RsTotal,
                                     double ygAve, double yN2, bool PbImpurityCorrection, 
                                     double Cp1 = 1.0, double Cp2 = 0.0)
        {
        ...
        /// <param name="T"></param>
        /// <returns></returns>
        public static double PbStanding(double T, double Api, double RsTotal, double ygAve, 
                                    double yN2, bool PbImpurityCorrection, double Cp1 = 1.0,
                                    double Cp2 = 0.0)
        {
        ...
        /// <param name="T">temperature in fahrenheit</param>
        /// <returns>bubble point in psia</returns>
        public static double PbVazquezBeggs(double T, double Api, double RsTotal, double ygAve,
                                        double yN2, bool PbImpurityCorrection, double Cp1 = 1.0,
                                        double Cp2 = 0.0)
        {
        ...
        public static double OilDensity( double Api, double Rs, double Bo, double ygAve)
        {
            double yo, rhoo;
            yo = 141.5 / (131.5 + Api);
        ...
        public static IEnumerable<double> BlackOilAlMarhoun(double P, double T, double API,
                                        ...
                                        double Tst, bool pbImpurityCorrection, double ygAve, 
                                        double yN2 = 0.0, double Cp1Bo = 1.0, double Cp2Bo = 0.0,
                                        double Cp3Bo = 1.0, double Cp4Bo = 0.0, double Cp1Pb = 1.0,
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            double Rs, Pb, Bo, co;
            //Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);

            Pb = PbAlMarhoun(T, API, GOR, ygAve, yN2, pbImpurityCorrection, Cp1Pb, Cp2Pb);

            Rs = RsAlMarhoun(P, T, Pb, API, GOR, Tst, ygAve, Cp1Rs, Cp2Rs);
            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoAlMarhoun(P, T, Pb, Rs, API, GOR, gasgrav, Psep, Tsep, ygAve, 
                            Cp1Bo, Cp2Bo, Cp3Bo, Cp4Bo);
        ...
        public static IEnumerable<double> BlackOilDeGhetto(double P, double T, double API,
                                        double gasgrav,double GOR, double Psep, double Tsep,
                                        double R3, double ygAve, bool pbImpurityCorrection, 
                                        SeparatorStage separatorTrain, double yN2 = 0.0, 
                                        double Cp1Bo = 1.0, double Cp2Bo = 0.0, 
                                        double Cp3Bo = 1.0, double Cp4Bo = 0.0, double Cp1Pb = 1.0,
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            ...
            Pb = PbDeGhetto(T, API, GOR, Psep, Tsep, R3, ygAve, yN2, pbImpurityCorrection, 
                            separatorTrain, Cp1Pb, Cp2Pb);

            Rs = RsDeGhetto(P, T, API, gasgrav, Psep, Tsep, Cp1Rs, Cp2Rs);
            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
        ...
        public static IEnumerable<double> BlackOilGlaso(double P, double T, double API, 
                                        double gasgrav, double GOR, double Psep, double Tsep,
                                        double Tst, bool pbImpurityCorrection, double ygAve, double yN2 = 0.0,
                                        double yCO2 = 0.0, double yH2S = 0.0, double Cp1Bo = 1.0, double Cp2Bo = 0.0,
                                        double Cp3Bo = 1.0, double Cp4Bo = 0.0, double Cp1Pb = 1.0,
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            double Rs, Pb, Bo, Rp, co;
            Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);
            Pb = PbGlaso(T, API, GOR, ygAve, yCO2, yH2S, yN2, 
                        pbImpurityCorrection, Cp1Pb, Cp2Pb);     
            
            Rs = RsGlaso(P, T, Pb, API, GOR, Tst, ygAve, Cp1Rs, Cp2Rs);

            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoGlaso(P, T, Pb, Rs, API, GOR, gasgrav, Psep, Tsep, 
                        ygAve, Cp1Bo, Cp2Bo, Cp3Bo, Cp4Bo);
                                        ...
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            ...
            Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);
            Pb = PbLasater(T, API, GOR, ygAve, yN2, pbImpurityCorrection, Cp1Pb, Cp2Pb);

            Rs = RsLasater(P, T, Pb, API, GOR, Tst, ygAve, Cp1Rs, Cp2Rs);

            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoLasater(P, T, Pb, Rs, API, GOR, gasgrav, Psep, Tsep, ygAve, Cp1Bo, 
                           Cp2Bo, Cp3Bo, Cp4Bo);
                                        ...
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            ...
            Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);
            Pb = PbPetroskyFarshard(T, API, GOR, ygAve, yN2, pbImpurityCorrection, Cp1Pb, Cp2Pb);

            Rs = RsPetroskyFarshad(P, T, Pb, API, GOR, Tst, ygAve, Cp1Rs, Cp2Rs);

            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoPetroskyFarshard(P, T, Pb, Rs, API, GOR, ygAve, Cp1Bo, Cp2Bo, Cp3Bo, Cp4Bo);
                                        ...
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            ...
            //Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);
            Pb = PbStanding(T, API, GOR, ygAve, yN2, pbImpurityCorrection, Cp1Pb, Cp2Pb);

            Rs = RsStanding(P, T, Pb, API, GOR, Tst, ygAve, Cp1Rs, Cp2Rs);

            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoStanding(P, T, Pb, Rs, API, GOR, gasgrav, Psep, Tsep, ygAve,
                            Cp1Bo, Cp2Bo, Cp3Bo, Cp4Bo);
                                        ...
                                        double Cp2Pb = 0.0, double Cp1Rs = 1.0, double Cp2Rs = 0.0)
        {
            ...
            //Rs = Rp = GOR;
            double gasgrav100 = gasgrav100VazquezAndBeggs(API, gasgrav, Psep, Tsep);
            Pb = PbVazquezBeggs(T, API, GOR, ygAve, yN2, pbImpurityCorrection, Cp1Pb, Cp2Pb);

            Rs = RsVazquezBeggs(P, T, Pb, API, GOR, Psep, Tsep, Tst, ygAve, Cp1Rs, Cp2Rs);

            Rs = sanity_check_on_Rs(Rs, GOR);
            co = CoVazquezAndBeggs(P, T, API, gasgrav100, Rs);
            Bo = BoVazquezBeggs(P, T, Pb, Rs, API, GOR, gasgrav, Psep, ygAve, 
                                Cp1Bo, Cp2Bo, Cp3Bo, Cp4Bo);
        ...
        public static double ComputeOilViscosity(double P, double T, double Pb, double rs,
                                    double RsTotal, double Api, OilViscosityCorr oilViscCorr,
                                    double tp = 0, double Cp1 = 1.0, double Cp2 = 0.0, 
                                    double Cp3 = 1.0, double Cp4 = 0.0)
        {
            double muO = 0;
            if(oilViscCorr == OilViscosityCorr.Beal_et_al)
            {
                muO = BealViscosity(P, T, Pb, rs, RsTotal, Api, Cp1, Cp2, Cp3, Cp4);
            }
            else if (oilViscCorr == OilViscosityCorr.BeggsRobinson)
            {
                muO = BeggRobinsonViscosity(P, T, Pb, rs, RsTotal, Api, Cp1, Cp2, Cp3, Cp4);
            }
            else if(oilViscCorr == OilViscosityCorr.Bergman_Sutton)
            {
                muO = BergemanSuttonViscosity(P, T, Pb, rs, Api, RsTotal, Cp1, Cp2, Cp3, Cp4);
            }
            else if(oilViscCorr == OilViscosityCorr.DeGhetto)
            {
                muO = DeGhettoViscosity(P, T, Pb, rs, Api, RsTotal, Cp1, Cp2, Cp3, Cp4);
            }
            else if(oilViscCorr == OilViscosityCorr.Egbogah_et_al)
            {
                muO = EgbogahViscosity(P, T, Pb, rs, Api, RsTotal, tp, Cp1, Cp2, Cp3, Cp4);
            }
            else if(oilViscCorr == OilViscosityCorr.Petrosky_et_al)
            {
                muO = PetroskyFarshardViscosity(P, T, Pb, rs, Api, RsTotal, Cp1, Cp2, Cp3, Cp4);
            }
